                            ...
                            msg.text.length==0?SizedBox():Expanded(
                                child: TextButton(
                                  ...
                                  onPressed: (){
                                    ...
                                    socket.emit('sendMessage', {"sender":sharedPreferences.getString("mail"),"senderType":"buyer","message":msg.text,"receiver":sender,"receiverType":"coder"});
                                    msg.clear();
                                  },
      ...
      body: loading&&connecting?Center(
        ...
        return ListTile(
          onTap: ()async{
            ...
            var res=await service.buyerChatHistory(id: sharedPreferences.getString("mail"), chatWithId: result[index]["chatWithId"]);
            print(res);
            if(res!="error")
              messages=res;
